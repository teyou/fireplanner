...
test.describe('Monte Carlo Simulation', () => {
  ...
  test('companion mode runs in planner route and renders companion charts', async ({ page }) => {
    ...
    expect(firstPayload).toHaveProperty('schema_version', 2)
    ...
    expect(firstPayload).toHaveProperty('wr_safe_90')
    expect(firstPayload).toHaveProperty('wr_safe_85')
    expect(firstPayload).toHaveProperty('wr_safe_50')
    expect(firstPayload).not.toHaveProperty('schemaVersion')
    expect(firstPayload).not.toHaveProperty('WR_critical_50')
    expect(firstPayload).not.toHaveProperty('wr_critical_10')
    expect(firstPayload).not.toHaveProperty('wr_critical_90')
    expect(firstPayload).not.toHaveProperty('horizonYears')
    expect(firstPayload).not.toHaveProperty('allocationSummary')
    expect(firstPayload).not.toHaveProperty('fire_age')
    expect(firstPayload).not.toHaveProperty('portfolio_at_fire')
  })
})
