  ...
  return [
    {
      ...
      min: Math.max(6000, Math.round(profile.annualExpenses * 0.5)),
      max: Math.round(profile.annualExpenses * 2),
      step: 1000,
    ...
    },
    {
      key: 'annualIncome',
      label: 'Annual Income',
      min: Math.max(0, Math.round(profile.annualIncome * 0.5)),
      max: Math.round(profile.annualIncome * 2),
      step: 1000,
      format: (v) => formatCurrency(v),
    },
    {
    ...
    },
    {
      ...
      min: Math.max(profile.retirementAge - 15, 30),
      max: Math.min(profile.retirementAge + 15, 80),
      step: 1,
    ...
    },
    {
      ...
      min: 0,
      max: Math.max(Math.round(profile.liquidNetWorth * 3), 500000),
      step: 10000,
      format: (v) => formatCurrency(v),
    },
  ]
