...
function AppLayoutFooterCta() {
  const { isEligible, openModal, trackImpression } = useExpenseTracker()
  ...
  return (
    <p className="text-xs text-center mb-2">
      <span className="text-muted-foreground">Want a companion expense tracker?</span>{' '}
      <button
        onClick={() => {
          ...
          <div className="flex flex-1 md:min-h-0 relative">
            ...
            >
              ...
              <footer className="container max-w-6xl pb-6 px-6">
                {!companionMode && <AppLayoutFooterCta />}
